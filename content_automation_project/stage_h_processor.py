...
class StageHProcessor(BaseStageProcessor):
    ...
    def process_stage_h(
        ...
        # Split Stage J data into three parts (for prompt)
        ...
        part3_data = stage_j_records_for_prompt[part_size * 2:]
        
        _progress(f"Splitting Stage J data into 3 parts: Part 1 ({len(part1_data)} records), Part 2 ({len(part2_data)} records), Part 3 ({len(part3_data)} records)")
...
{part3_json_str}"""
        ...
        # Extract JSON from all three responses
        ...
        _progress("Combining JSON from all three parts...")
        ...
        combined_model_data = part1_data_list + part2_data_list + part3_data_list
