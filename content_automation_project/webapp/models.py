...
class GeminiTtsApiKey(Base):
    ...
    rpm_limit = Column(Integer, default=3, nullable=False)
    rpd_limit = Column(Integer, default=10, nullable=False)
    requests_today = Column(Integer, default=0, nullable=False)
    requests_in_minute = Column(Integer, default=0, nullable=False)
    rpm_window_start = Column(DateTime, nullable=True)
    daily_quota_date = Column(String(10), nullable=True)
