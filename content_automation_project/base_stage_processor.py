...
class BaseStageProcessor:
    ...
    def get_data_from_json(self, json_data: Dict) -> List[Dict]:
        """
        Extract data array from JSON.
        Supports multiple structures: {metadata, data}, {metadata, points}, {rows}
    ...
    def load_txt_as_json_from_text(self, text: str) -> Optional[Dict]:
        """
